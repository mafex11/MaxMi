...
- [ ] **Step 1: Rebuild + relaunch** (grant persists; no tccutil reset): `./packaging/make-app.sh && pkill -9 -x MaxMi; sleep 2; open MaxMi.app`. Grant Microphone + Screen Recording when first prompted (on first Record).
